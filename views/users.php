...
<div class="container">
		...
		<div class="tab-content">
  			<div class="tab-pane active" id="list">
  				<br/>
  				<p><button type="button" class="btn btn-danger"><span class="glyphicon glyphicon-plus"></span> Nuevo Usuario<butto></p>
  				<br/>
  					...
  					<table class="table table-hover">
						...
						<?php foreach($users as $user) { ?>
    							<tr>
    								...
    								<td><?php echo $user['nombre de usuario']; ?></td>
   ...
   <a href="index.php?controller=users&del=<?php echo $user['id']; ?>"><span class="glyphicon glyphicon-trash"></span> Borrar</a>
    								</td>
    							</tr>
...
<?php } ?>
  			...
  			<div class="tab-pane" id="edit">
				...
				<div class="alert alert-danger" role="alert"><button type="button" class="close" data-dismiss="alert"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button></div>
  				<br/>
  				<form role="form">
